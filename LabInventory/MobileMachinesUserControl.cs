...
using parentClass = LabInventory.WorkshopUserControl;
...
namespace LabInventory
{
    public partial class MobileMachinesUserControl : UserControl
    {
        ...
        const string CATEGORY = "MobileMachines";
        const string PARENT_USER_CONTROL = "WorkshopUserControl";
        ...
        private void MobileMachinesUserControl_Load(object sender, EventArgs e)
        {
