...
using parentClass = LabInventory.InstrumentsUserControl;

namespace LabInventory
{
    public partial class OtherInstruments : UserControl
    {

        const string CATEGORY = "OtherInstruments";
        const string PARENT_USER_CONTROL = "InstrumentsUserControl";
        ...
        private void OtherInstruments_Load(object sender, EventArgs e)
        {
